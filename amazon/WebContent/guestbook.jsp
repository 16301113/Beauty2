...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="${pageContext.request.contextPath}/index.jsp">亚马逊</a>
		&gt; 在线留言
	</div>
					...
					<c:forEach items="${requestScope.listcom}" var="guestbooks">
						...
						<li>
							<dl>
								...
								<dd class="author">
									<span>作者：${guestbooks.hc_nick_name}</span>
								</dd>
								<dd>评论时间：${guestbooks.hc_create_time}</dd>
								<dd>回复：${guestbooks.hc_pepiy}</dd>
								<dd>回复时间：${guestbooks.hc_reply_time}</dd>
							</dl>
						</li>
					</c:forEach>
